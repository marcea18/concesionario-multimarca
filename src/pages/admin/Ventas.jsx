...
const Ventas = () => {
  ...
  return (
    <div className='flex xl:relative w-full items-center justify-center'>
      <form ref={form} onSubmit={submitForm} className='flex flex-col h-full'>
        <h1 className='text-3xl font-extrabold text-gray-900 my-3'>Crear una nueva venta</h1>
        <label className='flex flex-col' htmlFor='vendedor'>
          <span className='text-2xl font-gray-900 text-center'>Vendedor</span>
          <select name='vendedor' className='p-2' defaultValue='' required>
            <option disabled value='' className='text-2xl font-gray-900 text-center'>
        ...
        <div className='flex flex-col'>
          <span className='text-2xl font-gray-800 text-center'>Selección de Vehículos</span>
          <button
            type='button'
            onClick={() => agregarNuevoVehiculo()}
            className='col-span-2 bg-green-800 p-2 rounded-full shadow-md hover:bg-green-600 text-white'
          >
        ...
        <label className='flex flex-col'>
          <span className='text-2xl font-gray-700 text-center'>Valor Total Venta</span>
          <input
...
const DropDownVehiculos = ({ vehiculos, nombre }) => {
  return (
    <label className='flex flex-col' htmlFor='vehiculo'>
      <span className='text-2xl font-gray-900 text-center'>Vehículo</span>
